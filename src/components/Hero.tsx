...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Neural particle canvas — the global ambient background shows through it */}
      <NeuralBackground />
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-5 sm:px-8">
        ...
        {/* Stats — full-width bar under the intro */}
        <motion.dl
          initial={{ opacity: 0, y: 24 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          {profile.stats.map((s, i) => (
            <div key={i} className="bg-bg/50 px-5 py-5 backdrop-blur">
